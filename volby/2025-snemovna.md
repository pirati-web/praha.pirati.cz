...
{% capture mainContent %}{% endcapture %}

{% capture subContent %}<img src="https://a.pirati.cz/praha/img/people/hrib2025.jpg" style="float: right; margin: 0 0 1em 1em; width: 300px;">
...
{% include elections-header.html img=page.img bgImg=page.heroBgImg mainContent=mainContent subContent=subContent %}
